...
class Organization(Base, TimestampMixin):
    ...
    # Mirror / hub deals round-robin (see mirror_deal_pipeline_service).
    mirror_round_robin_last_pipeline_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
